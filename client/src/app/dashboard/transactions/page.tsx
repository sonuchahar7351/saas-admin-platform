...
import { DonationRecord, donationsAdminApi } from "@/lib/donations-admin-api";
...
function TransactionsContent() {
  ...
  const table = useReactTable({
    ...
    manualSorting: true, // server does the sorting, TanStack just tracks UI state
      ...
      <div className="mb-4 flex flex-wrap items-center gap-2">
        ...
        >
          ...
          <input
            ...
            placeholder="Search name, email, payment ID, campaign slug"
